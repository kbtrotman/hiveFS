...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: aoq7w2IY8Vqj/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__ox2M)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__fM8W3)}>
            <div
              className={classNames(
                projectcss.all,
