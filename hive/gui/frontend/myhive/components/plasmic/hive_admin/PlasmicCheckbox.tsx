...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: X56oE6esjW61/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: pL2oHtZH8V0H/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: KA6MEFVwjAa8/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg__qfyjH)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg___5L1Zb)}
            role={"img"}
          />
        ) : null}
      </div>
