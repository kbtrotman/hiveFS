...
import sty from "./PlasmicButton.module.css"; // plasmic-import: uLyzQyBGpU2p/css
...
function PlasmicButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__dDxU, {
          [sty.freeBoxcolor_neutral__dDxUzzFhO]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxroundedFull__dDxU2488]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__dDxUrPhac]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__dDxU7VOlN]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__dDxU2IIer]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__dDxU2S8Bb]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__dDxUolUtc]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_bordered_color_success__dDxUolUtcT2MlK]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__cmoyp, {
            [sty.freeBoxcolor_neutral__cmoypZzFhO]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__cmoypZzFhOZQn8A]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart__cmoypnRgCg]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__cmoyprPhac]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__cmoyp2IIer]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__cmoyp2S8Bb]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__cmoypolUtc]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__aEzbp)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__zMnGe, {
            [sty.freeBoxiconEnd__zMnGebJdqu]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__zMnGErPhac]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__zMnGe2IIer]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__zMnGe2S8Bb]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__qAcjm)}
                role={"img"}
              />
            ),
