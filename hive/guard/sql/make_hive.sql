...
CREATE TABLE IF NOT EXISTS storage_nodes (
  ...
  database_state   ENUM('unconfigured', 'pending', 'active', 'degraded', 'offline', 'retired', 'blanked', 'configured'),
  kv_state         ENUM('unconfigured', 'pending', 'active', 'degraded', 'offline', 'retired', 'blanked', 'configured'),
  ...
  hive_version     INT DEFAULT NULL,
  hive_patch_level INT DEFAULT NULL,
  ...
  meta_capacity_bytes BIGINT UNSIGNED DEFAULT NULL,
  meta_used_bytes  BIGINT UNSIGNED DEFAULT NULL,
  meta_reserved_bytes BIGINT UNSIGNED DEFAULT NULL,
  meta_overhead_bytes BIGINT UNSIGNED DEFAULT NULL,
  storage_capacity_bytes BIGINT UNSIGNED DEFAULT NULL,
  storage_used_bytes BIGINT UNSIGNED DEFAULT NULL,
  storage_reserved_bytes BIGINT UNSIGNED DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS storage_node_stats (
  ...
  kv_rocksdb_writes      BIGINT UNSIGNED,
  kv_rocksdb_write_ns    BIGINT UNSIGNED,
  contig_write_calls     BIGINT UNSIGNED,
  contig_write_bytes     BIGINT UNSIGNED,
